...
public class NamespaceException extends RuntimeException {
	...
	public NamespaceException(String message, Throwable cause, boolean enableSuppression, boolean writableStackTrace) {
	...
	private static final long serialVersionUID = -7421923896619311652L;
